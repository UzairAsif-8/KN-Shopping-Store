...
export const CATEGORIES = [
  ...
  },
  {
    ...
    label: 'Grocery',
    eyebrow: 'Shop the',
    description: 'Everyday pantry and household essentials for convenient shopping',
    count: 'Fresh picks',
    href: '/shop?category=grocery',
    image: IMAGES.categories.grocery,
    accent: '#8A9B5A',
    featured: false,
  },
  {
    ...
    image: IMAGES.categories.cosmetic,
    accent: '#E29AA1',
    featured: false,
  },
  {
    ...
    label: 'Electronics',
    eyebrow: 'Shop the',
    description: 'Smart devices and accessories for your daily routine',
    count: 'Tech picks',
  ...
  },
  {
    ...
    image: IMAGES.categories.luggage,
    accent: '#7E6B8F',
    featured: false,
  },
];
