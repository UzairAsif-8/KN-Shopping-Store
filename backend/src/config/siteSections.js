...
export const SITE_SECTION_GROUPS = [
  ...
  },
  {
    ...
    sections: [
      ...
      { key: 'categories.grocery', label: 'Grocery Category' },
      { key: 'categories.cosmetic', label: 'Cosmetic Category' },
      { key: 'categories.electronics', label: 'Electronics Category' },
      { key: 'categories.essentials', label: 'Men and Women Essentials Category' },
      { key: 'categories.luggage', label: 'Luggage Category' },
    ],
  },
  {
    id: 'collections',
...
export const DEFAULT_SITE_IMAGES = {
  ...
  'categories.grocery': p(3685530, 800),
  'categories.cosmetic': p(3997987, 800),
  'categories.electronics': p(9654031, 800),
  'categories.essentials': p(1459481, 800),
  'categories.luggage': p(4938508, 800),
