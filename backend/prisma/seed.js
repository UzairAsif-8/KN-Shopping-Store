...
const PRODUCTS = [
  ...
  { name: 'Pantry Essentials Box', slug: 'pantry-essentials-box', category: 'grocery', price: 34, featured: false, stock: 150, images: [p(3685530), p(2533266), p(4465124)] },
  { name: 'Home Stockup Crate', slug: 'home-stockup-crate', category: 'grocery', price: 58, featured: true, stock: 90, images: [p(4465124), p(3685530), p(2533266)] },
  { name: 'Daily Living Bundle', slug: 'daily-living-bundle', category: 'cosmetic', price: 44, featured: true, stock: 120, images: [p(3997987), p(1459481), p(2539396)] },
  { name: 'Fresh Start Kit', slug: 'fresh-start-kit', category: 'cosmetic', price: 39, featured: false, stock: 140, images: [p(1459481), p(3997987), p(2539396)] },
  { name: 'Smart Essentials Speaker', slug: 'smart-essentials-speaker', category: 'electronics', price: 89, featured: true, stock: 75, images: [p(9654031), p(3018845), p(3993446)] },
  { name: 'Compact Power Bank', slug: 'compact-power-bank', category: 'electronics', price: 27, featured: false, stock: 180, images: [p(3018845), p(9654031), p(3993446)] },
  { name: 'Everyday Essentials Set', slug: 'everyday-essentials-set', category: 'essentials', price: 52, featured: false, stock: 140, images: [p(1459481), p(4938508), p(3373736)] },
  { name: 'Everyday Travel Pouch', slug: 'everyday-travel-pouch', category: 'essentials', price: 22, featured: false, stock: 220, images: [p(4938508), p(1459481), p(3373736)] },
  { name: 'Travel Carry-On Case', slug: 'travel-carry-on-case', category: 'luggage', price: 110, featured: true, stock: 65, images: [p(4938508), p(9654031), p(2533266)] },
  { name: 'Weekend Duffel Bag', slug: 'weekend-duffel-bag', category: 'luggage', price: 74, featured: false, stock: 100, images: [p(9654031), p(4938508), p(2533266)] },
